    ...
    var todoNodes = this.props.data.map(function(todo, index) {
      return (
        React.createElement("li", {className: "todoListItem"}, 
          React.createElement("textarea", {className: "todo", key: index, value: todo.Item, onChange: this.handleEdit.bind(this, todo.Id), ref: "todoItem"}), 
          React.createElement("button", {key: index, onClick: this.handleDelete.bind(this, todo.Id)}, "Del")
        )
      );
