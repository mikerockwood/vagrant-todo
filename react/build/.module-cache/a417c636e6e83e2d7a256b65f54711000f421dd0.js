...
var TodoList = React.createClass({displayName: "TodoList",
  handleEdit: function(idToEdit) {
    var itemToEdit = React.findDOMNode(this.className.todo).children;
    ...
    var todoNodes = this.props.data.map(function(todo, index) {
      return (
        React.createElement("li", {className: "todoListItem"}, 
          ...
          React.createElement("div", {className: "todo", key: index, contentEditable: true, onInput: this.handleEdit.bind(this, todo.Id)}, 
            todo.Item
          ), 
