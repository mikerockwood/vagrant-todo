var TodoContainer = React.createClass({displayName: "TodoContainer",
  ...
  handleTodoEdit: function(itemToEdit) {
    React.createElement("form", {className: "todoEdit", onSubmit: this.handleEditSubmit.bind(this, itemToEdit)}, 
      React.createElement("input", {type: "text", placeholder: "", ref: "editRef"})
    )
  },
  handleEditSubmit: function(itemToEdit) {
...
var Todo = React.createClass({displayName: "Todo",
  render: function() {
    return (
      React.createElement("li", {className: "todo", contentEditable: true, ref: "todoItem"}, 
        this.props.children
      )
    );
  }
