...
var TodoList = React.createClass({displayName: "TodoList",
  handleEdit: function(itemToEdit) {
    this.props.onTodoEdit(this.props.id, itemToEdit);
  },
  ...
  render: function() {
    var todoNodes = this.props.data.map(function(todo, index) {
      return (
        React.createElement(Todo, {key: index, id: todo.Id, onEdit: this.handleEdit}, 
          todo.Item, 
...
var Todo = React.createClass({displayName: "Todo",
  handleInput: function() {
    this.props.onEdit(React.findDOMNode(this.refs.todoItem).value.trim());
  },
  render: function() {
    return (
